...
const tarefasD1 = [
    ...
    '<button class="botcontinuar" id="3" onclick="apresentaDilema(1)(dilema1, trilha)">Continuar...</button>'
...
const tarefasD2 = [
    ...
    '<button class="botcontinuar" id="5" onclick="escreveDialogo(dialogoMecanico.interlocutores, dialogoMecanico.textos)">Continuar...</button>',
    {
    ...
    document.getElementById("chamadilema2")
]
// tarefas do dia 3
const tarefasD3 = [
    {
